...
// Data compiled from public sources - major locations across states where In-N-Out operates
const inNOutLocations = [
    // California - Major cities (sample of locations)
    ...
    // Oregon
    { lat: 43.8041, lng: -120.5542, city: "Redmond, OR" },
    { lat: 42.3265, lng: -122.8756, city: "Grants Pass, OR" },
    { lat: 42.2127, lng: -121.7817, city: "Klamath Falls, OR" },
